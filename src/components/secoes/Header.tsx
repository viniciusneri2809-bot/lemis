...
export function Header() {
  ...
  const vidro = rolou || aberto
    ? "border-fio-claro bg-[color-mix(in_srgb,var(--color-papel)_90%,transparent)] shadow-[0_12px_40px_-20px_color-mix(in_srgb,var(--color-tinta)_40%,transparent)] backdrop-blur-md"
